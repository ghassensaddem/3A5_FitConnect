...
class SallesportifRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(Sallesportif $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(Sallesportif $entity, bool $flush = true): void
    {
    ...
    // /**
    //  * @return Sallesportif[] Returns an array of Sallesportif objects
    //  */
    /*
    ...
    */
    ...
    /*
    public function findOneBySomeField($value): ?Sallesportif
    {
        return $this->createQueryBuilder('s')
            ->andWhere('s.exampleField = :val')
            ->setParameter('val', $value)
