...
public class CommandeController {
    ...
    public void initialize() {
        ...
        // Exemple : Récupérer l'ID du client (à remplacer par la valeur réelle)
        int clientId = 1; // Remplacez par l'ID du client connecté
        ...
        if (!commandes.isEmpty()) {
            ...
            String clientPhoneNumber = commandeService.getClientphoneById(1);
    ...
    private void onContinueShopping() {
        try {
            ...
            // Récupérer l'ID du client (à remplacer par la valeur réelle)
            int clientId = 1; // Remplacez par l'ID du client connecté
