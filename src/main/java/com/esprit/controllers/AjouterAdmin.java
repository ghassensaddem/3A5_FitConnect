...
public class AjouterAdmin{
    ...
    void Add(ActionEvent event) throws IOException {
        if(validateFields()){
            ...
            cs.ajouter(new Admin(0, nom.getText(), prenom.getText(), sexe, cryptoUtils.encrypt(mdp.getText()), DateNaissance.getValue().toString(), email.getText(), pdpPathField.getText(), role));
            nom.setText("");
            prenom.setText("");
            mdp.setText("");
            email.setText("");
            ...
            alert.setContentText("Admin a ete ajoutée");
            alert.showAndWait();
