...
public class AjouterCoach{
    ...
    void Add(ActionEvent event) throws IOException {
        if(validateFields()){
            ...
            cs.ajouter(new Coach(0,nom.getText(),prenom.getText(), sexe,cryptoUtils.encrypt(mdp.getText()),DateNaissance.getValue().toString(),email.getText(),pdpPathField.getText(),lieuEngagement.getValue(),specialite.getValue()));
