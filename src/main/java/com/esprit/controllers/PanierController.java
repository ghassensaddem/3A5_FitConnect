...
public class PanierController {
    ...
    public void loadCart() {
        ...
        List<Commande> commandes = commandeService.rechercherParClientId(clientId);
    ...
    private void clearAllCommands() {
        ...
        commandeService.supprimerToutesLesCommandes(clientId); // Remplacez 1 par l'ID du client connecté
    ...
    private void passerCommande() {
        try {
            ...
            commandeService.passerCommande(clientId);
