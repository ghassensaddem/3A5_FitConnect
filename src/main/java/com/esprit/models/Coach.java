...
public final class Coach extends User {
    ...
    public Coach(int id, String nom, String prenom, String sexe, String mdp, String dateNaissance, String email,String image, String lieuEngagement, String specialite) {
